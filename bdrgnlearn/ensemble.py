...
class GradientBoostingRegressor:
    # Initialize the object entity
    def __init__(self, min_samples_leaf=1, max_depth=3, n_trees=10, threshold=0.5):
    ...
    def fit(self, X, y):
        ...
        for i in range(self.n_trees_):
            ...
            # Make predictions with current trees
    ...
    def predict(self, X):
        ...
        # Take the sum of all trees for each observation in dataset
